...
export const initialCars: Car[] = [
  ...
  { id: 'B', length: 2, orientation: 'vertical', position: { row: 0, col: 2 }, color: 'bg-orange-500' },
  { id: 'C', length: 2, orientation: 'vertical', position: { row: 1, col: 0 }, color: 'bg-sky-500' },
  { id: 'D', length: 2, orientation: 'vertical', position: { row: 4, col: 1 }, color: 'bg-pink-500' },
  { id: 'E', length: 2, orientation: 'horizontal', position: { row: 4, col: 2 }, color: 'bg-purple-500' },
  { id: 'O', length: 3, orientation: 'vertical', position: { row: 0, col: 3 }, color: 'bg-yellow-500' },
  { id: 'P', length: 3, orientation: 'vertical', position: { row: 0, col: 4 }, color: 'bg-violet-500' },
  { id: 'Q', length: 3, orientation: 'vertical', position: { row: 2, col: 5 }, color: 'bg-blue-500' },
  { id: 'R', length: 3, orientation: 'horizontal', position: { row: 5, col: 3 }, color: 'bg-emerald-500' },
];
